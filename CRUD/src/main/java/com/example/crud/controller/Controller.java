...
public class Controller {
    ...
    @GetMapping("/data")
    public Page<ClientDto> getClientPageOne(Pageable pageable){
...
//            }
//        });
        return clientRepository.findAll(pageable).map(client -> new ModelMapper().map(client, ClientDto.class));
    }
